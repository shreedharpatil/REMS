...
adminmodule.controller('EditAgentCustomerDetailsModalController',
    function ($scope, EditAgentCustomerDetailsModalService, $modalInstance, $rootScope) {
        $scope.Model = EditAgentCustomerDetailsModalService;
...
adminmodule.service('EditAgentCustomerDetailsModalService', function ($http) {
    this.Body = '';
    this.Customer = {};
	this.Files = [];
